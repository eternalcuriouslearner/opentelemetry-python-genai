...
"""Per-scenario conformance tests for claude-agent-sdk."""
...
pytest.importorskip("pytest_vcr")
...
from .conformance.query import QueryScenario


@pytest.mark.parametrize(
    "scenario",
    [pytest.param(QueryScenario())],
